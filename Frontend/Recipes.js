document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCreateRecipeButton() {
        ...
        button.style.cssText = 'margin-bottom:30px;font-size:18px;padding:20px 50px;border-radius:50px;box-shadow:0 8px 32px rgba(66,165,245,0.4),inset 0 1px 0 rgba(255,255,255,0.2);font-weight:800;letter-spacing:0.5px;background:linear-gradient(145deg,#42A5F5 0%,#1976D2 100%);border:3px solid #0D47A1;color:#FFFFFF;cursor:pointer;transition:all 0.3s cubic-bezier(0.23, 1, 0.32, 1);position:relative;overflow:hidden;text-shadow:0 2px 4px rgba(15,20,25,0.2);';
